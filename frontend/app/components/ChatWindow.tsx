...
const MODEL_TYPES = ["ollama_llama3", "openai_gpt_3_5_turbo", "fireworks_mixtral"];
...
export function ChatWindow(props: { conversationId: string }) {
  ...
  const [llm, setLlm] = useState(
    searchParams.get("llm") ?? "ollama_llama3",
  );
  ...
  const sendMessage = async (message?: string) => {
    ...
    try {
      ...
      const llmDisplayName = llm ?? "ollama_llama3";
          ...
          <div className="flex items-center mb-2">
            ...
            {llmIsLoading ? (
              ...
              <Select
                ...
                width={"240px"}
              >
		<option value="ollama_llama3">Ollama (llama3)</option>
